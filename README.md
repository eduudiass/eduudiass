<h1 align="center">Eduardo Dias</h1>

<p align="center">
  Data Science & AI student at PUCRS | SQL • Python • Power BI
</p>

<p align="center">
  Building projects focused on data analytics, business intelligence, and the financial sector.
</p>
...
Dashboard completo para gestão de uma frota de veículos de aluguel. Desenvolvido a partir de
uma planilha Excel com 7 módulos integrados, evoluiu para um dashboard web com KPIs de receita,
manutenções, gastos fixos, compras e vendas. Atualização automática via script Python.

`Excel` `Python` `JavaScript` `Chart.js`

### [World Cup Dashboard](https://github.com/eduudiass/copa-do-mundo-dashboard)

Dashboard interativo com análise de gols por edição, fase, minuto e país em todas as Copas do
Mundo da FIFA.
